    ...
    return (
      <View style={styles.blockContainer}>
        ...
        <View style={styles.blockIconWrap}>
          <Ionicons name="location" size={60} color={theme.danger} />
        </View>
        ...
        <TouchableOpacity style={{ marginTop: 20 }} onPress={() => Linking.openSettings()}>
          <Text style={{ color: theme.primary, fontWeight: 'bold', fontSize: 16 }}>Mở cài đặt thiết bị</Text>
        </TouchableOpacity>
      </View>
    );
  }
...
const getStyles = (theme: any) => StyleSheet.create({
  ...
  // Header
  headerArea: { backgroundColor: theme.primary, paddingHorizontal: 20, paddingTop: 50, paddingBottom: 50, position: 'relative', overflow: 'hidden' },
  ...
  gpsDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: theme.success, marginRight: 6 },
  gpsText: { color: '#FFF', fontSize: 12, fontWeight: 'bold' },
  avatarWrap: { width: 40, height: 40, borderRadius: 20, backgroundColor: theme.card, justifyContent: 'center', alignItems: 'center' },

  // Tabs
  tabContainerWrapper: { alignItems: 'center', marginTop: -25, zIndex: 10 },
  tabContainer: { flexDirection: 'row', backgroundColor: theme.card, padding: 5, borderRadius: 30, elevation: 4, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, width: '90%' },
  ...
  // Warning Banner
  warningBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.warningBackground, padding: 14, borderRadius: 12, marginBottom: 15, borderWidth: 1, borderColor: theme.warning },
  warningText: { color: theme.warning, fontSize: 14, marginLeft: 10, fontWeight: '500' },

  // Empty & Blocked States
  emptyState: { alignItems: 'center', marginTop: 80 },
  emptyTitle: { fontSize: 22, fontWeight: 'bold', color: theme.text, marginTop: 10 },
  emptySub: { fontSize: 15, color: theme.textSecondary, marginTop: 5 },

  blockContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: theme.card, padding: 30 },
  blockIconWrap: { width: 100, height: 100, borderRadius: 50, backgroundColor: theme.dangerBackground, justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  blockTitle: { fontSize: 20, fontWeight: 'bold', color: theme.text, marginBottom: 10 },
  blockDesc: { textAlign: 'center', color: theme.textSecondary, fontSize: 15, lineHeight: 22, marginBottom: 30 },
  blockBtn: { backgroundColor: theme.danger, paddingVertical: 15, paddingHorizontal: 30, borderRadius: 30, elevation: 3 },
