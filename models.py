...
from sqlalchemy import BigInteger, Boolean, DateTime, ForeignKeyConstraint, Integer, Numeric, PrimaryKeyConstraint, Sequence, String, Text, UniqueConstraint, text, ForeignKey
...
class TrackingLogs(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('id', 'system_time', name='tracking_logs_pkey'),
    )
