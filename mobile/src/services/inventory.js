...
export const inventoryService = {
    ...
    getVipAvailableExportNew: async (maKhoSpl = '') => {
        return await apiClient.get(WAREHOUSE_ENDPOINTS.GET_VIP_AVAILABLE_EXPORT_NEW(maKhoSpl));
    },

    getVipAvailableImportOld: async () => {
        return await apiClient.get(WAREHOUSE_ENDPOINTS.GET_VIP_AVAILABLE_IMPORT_OLD());
    },

    getVipAvailableExportOld: async (maKhoSpl = '') => {
        return await apiClient.get(WAREHOUSE_ENDPOINTS.GET_VIP_AVAILABLE_EXPORT_OLD(maKhoSpl));
    },

    getRegularAvailableExport: async (customerId, maKho = '') => {
        return await apiClient.get(WAREHOUSE_ENDPOINTS.GET_THUONG_AVAILABLE(customerId, maKho));
    },

    getRetailAvailableExport: async (customerId, maKho = '') => {
        return await apiClient.get(WAREHOUSE_ENDPOINTS.GET_LE_AVAILABLE(customerId, maKho));
    },
    ...
    importNewVip: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.VIP_IMPORT_NEW, payload);
    },

    exportNewVip: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.VIP_EXPORT_NEW, payload);
    },

    importOldVip: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.VIP_IMPORT_OLD, payload);
    },

    exportOldVip: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.VIP_EXPORT_OLD, payload);
    },

    // --- THƯỜNG ---
    importRegular: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.THUONG_IMPORT, payload);
    },

    exportRegular: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.THUONG_EXPORT, payload);
    },

    // --- LẺ ---
    importRetail: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.LE_IMPORT, payload);
    },

    exportRetail: async (payload) => {
        return await apiClient.post(WAREHOUSE_ENDPOINTS.LE_EXPORT, payload);
    },
