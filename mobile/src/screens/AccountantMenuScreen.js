...
export default function AccountantMenuScreen({ navigation }) {
    ...
    const accFunctions = [
        { id: 'CashConfirm', title: 'Chốt ca - Thu COD', sub: 'Thu tiền COD từ shipper', icon: 'wallet', color: COLORS.secondary, bg: COLORS.secondaryLight },
        { id: 'ShopStatement', title: 'Đối soát cửa hàng', sub: 'Tạo bảng kê, xuất Excel', icon: 'document-text', color: COLORS.primary, bg: COLORS.primaryLight },
        { id: 'WaybillList', title: 'Tra cứu vận đơn', sub: 'Xem lịch sử đơn hàng', icon: 'search', color: COLORS.secondary, bg: COLORS.secondaryLight },
        { id: 'AccountingDashboard', title: 'Báo cáo tài chính', sub: 'Tổng quan thu chi', icon: 'stats-chart', color: COLORS.primary, bg: COLORS.primaryLight },
    ];
            ...
            <View style={styles.mainHeader}>
                ...
                <View style={styles.headerTopRow}>
                    ...
                    <View style={styles.profileAvatar}>
                        <Text style={styles.avatarText}>{(user?.full_name || user?.username || 'K').charAt(0).toUpperCase()}</Text>
                    </View>
                </View>
            </View>
