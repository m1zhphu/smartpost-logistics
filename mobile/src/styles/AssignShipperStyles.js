...
const AssignShipperStyles = StyleSheet.create({
  ...
  radioLabel: { fontSize: 14, fontWeight: "700", color: COLORS.primary },
  ...
  pickupCardLeft: { flexDirection: "row", alignItems: "flex-start" },
  checkbox: {
    width: 30,
    height: 30,
    borderRadius: 10,
  ...
  formLabel: { color: COLORS.textMuted, fontWeight: "700", marginBottom: 8 },
  textInput: {
    backgroundColor: COLORS.inputBg,
    borderRadius: 16,
    borderWidth: 1,
