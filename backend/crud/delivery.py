    ...
    if pickup_bag:
        ...
        for index, item in enumerate(sorted_items, start=1):
            ...
            bag_waybills.append({
                ...
                "receiver_province_name": w.receiver_province_name,
                "receiver_ward_name": w.receiver_ward_name,
                "receiver_province_id": w.receiver_province_id,
                "receiver_ward_id": w.receiver_ward_id,
                "sender_name": w.sender_name,
                "sender_phone": w.sender_phone,
                "sender_address": w.sender_address,
                "sender_province_name": w.sender_province_name,
                "sender_ward_name": w.sender_ward_name,
                "sender_province_id": w.sender_province_id,
                "sender_ward_id": w.sender_ward_id,
